...
// sol_norm() mora em includes/solic.php (a API de leitura usa a mesma normalização)
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        // FASE 2 — COBERTURA DE COTAÇÃO POR ITEM (cinza=sem cotação · amarelo=em cotação · verde=finalizada/com PC).
        // A regra de casamento (seq > codprd > nome único) vive em includes/solic.php porque a API de
        // leitura (actions/api.php) consome exatamente a mesma cobertura — não pode divergir daqui.
