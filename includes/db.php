...
function db_schema_mysql($pdo) {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS neg_grupo (
        ...
        categoria VARCHAR(20) DEFAULT 'material',
...
function db_schema($pdo) {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS neg_grupo (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT, ordem INTEGER DEFAULT 0, categoria TEXT DEFAULT 'material', servicos TEXT, nota TEXT, updated_by TEXT, updated_at TEXT)");
