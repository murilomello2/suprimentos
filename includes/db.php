...
function db_schema($pdo) {
    ...
    foreach (['pct_fisico'=>'REAL','crono_inicio'=>'TEXT','crono_fim'=>'TEXT','crono_medicao'=>'TEXT','cronograma_nome'=>'TEXT','cronograma_at'=>'TEXT'] as $col=>$ty) if (!isset($ofcols[$col])) $pdo->exec("ALTER TABLE obra_ficha ADD COLUMN $col $ty");
